...
class ReportAdapter internal constructor(private val context: Activity, private val orderSummaryArrayList: ArrayList<Order>,
    ...
    override fun getGroupView(
        ...
        if(convertView == null) {
            ...
            conView = inflater.inflate(R.layout.report_order_summary, null)
        }
        val report_order_id = conView!!.findViewById<TextView>(R.id.report_order_id)
        val report_order_client_name = conView.findViewById<TextView>(R.id.report_order_client_name)
        ...
        report_order_client_name.text = orderSummary.orderClient
